 ...
 * 获取留资视频号信息
 */
@Component("GetFinderList")
public class GetFinderList {
    private static final Logger log = LoggerFactory.getLogger(GetFinderList.class);
    @Autowired
    ...
    {
        log.debug("====================获取留资视频号信息【GetBasicsInfo】====================");
        ...
        for (int i= 0;i<videoShopList.size();i++){
            try {
                ...
                HttpPost httpPost = new HttpPost("https://api.weixin.qq.com/channels/finderlive/get_finder_attr_by_appid?access_token="+videoShop.getAccessToken());
