...
//                }
                ...
                for(int i=0;i<5;i++){
                    getBeforeOrder(videoShop,calendar,stringEntity);
                }
    ...
    public void getBeforeOrder(VideoShop videoShop, Calendar calendar, StringEntity stringEntity) throws Exception{
        CloseableHttpClient httpClient = HttpClientBuilder.create().build();
        String resData = null;
        ...
        long end_time = calendar.getTimeInMillis() / 1000; // 获取当前时间戳，单位是毫秒，除以1000即可得到10位时间戳
